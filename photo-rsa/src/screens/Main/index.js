          ...
          <div className="Header">
            <div className="Title">
              ...
              <div class="TitleContent">
                ...
                <p className="SubtitleText">Created by Sean Kullmann and Hosung Lee</p>
              </div>
              </div>
              ...
              <p className="Message">Give it a try! Press the Button below</p>
              {
                ...
                <form className="UploadForm">
                  <label class="UploadButton">
                    <p>Upload</p>
                    <input id="imageInput" type="file" onChange={this.onChangeImage.bind(this)} ref={this.imageInputRef}/>
                  </label>
                ...
                : <div className="UploadForm"><ActivityIndicator/></div>
              }
              </div>
              <div className="Footer">
                <p><a href="https://github.com/Kullmann/RSAPhotoCryptography">Check out our github!</a></p><a href="https://github.com/Kullmann/RSAPhotoCryptography"><GithubLogo style={{marginLeft: 10}}/></a>
              </div>
          </div>
        </div>
    );
